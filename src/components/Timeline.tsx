...
const timelineData = [
  ...
  },
  {
    ...
    description:
      "Joined a program hosted by Discover through NIU called code_orange which paired teams of computer science students together to work on various projects. Worked on muliple interesting projects using a wide variety of Web frameworks inclucidne NodeJs, Angular, and React.",
    period: "2019 - 2020",
    company: 'Discover',
  ...
  },
  {
    ...
    description:
      "Studied Computer Science at Northern Illinois University. Coursework focused on learning C/C++ by implementign commonly used data structures like heaps and maps. Studied Assemble language using IBM System/360.",
    period: "2016 - 2019",
